...
public class RedisClient {
    ...
    { 
        ...
        jedisPool = new JedisPool(config,"192.168.56.109",6379);
    }
    ...
    { 
        ...
        shards.add(new JedisShardInfo("192.168.56.109", 6379, "master")); 
    ...
    public void show() {     
      ...
      private void KeyOperate() {
          ...
          //修改键名
          System.out.println("修改键名:"+jedis.rename("key001", "key01"));
